...
//             alert(JSON.stringify(responseJson.show_drower))
             ...
             alert(JSON.stringify(this.state.ditems))
    ...
    _onClickPiece=(item)=>{
      ...
      switch (item) {
        ...
        break;
        case "Travel Documents": this.props.navigation.navigate('Traveld')
        break;
        case "Applied Jobs": this.props.navigation.navigate('Applied')
        break;
...
switch (item) {
  ...
  break;
  case "Gallery":  this.props.navigation.navigate('Media')
  break;
  default:
